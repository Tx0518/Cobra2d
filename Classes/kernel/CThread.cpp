...
/*
Thread::Thread(IThreadEvent& event)
:m_event(event),m_bRun(false)
{
#ifdef WIN32
	m_hHandle = NULL;
#else
...
bool CThread::Run( FuntionPointer fun, void *pParam )
{
...
bool CThread::Run( MethodPointer method, void *pObj, void *pParam )
{
	if ( m_bRun ) return false;
...
//停止
void CThread::Stop( long lMillSecond )
{
#ifdef WIN32
